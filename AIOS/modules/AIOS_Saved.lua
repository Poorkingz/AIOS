...
Version: 1.0.0
Author: Poorkingz
Source: https://www.curseforge.com/members/aios/projects
Website: https://aioswow.info/
Discord: https://discord.gg/JMBgHA5T
Support: support@aioswow.dev
Donate: https://www.paypal.com/donate/?business=support%40aioswow.dev
...
API:
  AIOS.Saved:RegisterSchema(ns, defaults, opts) → schema
  AIOS.Saved:Get(ns, key, fallback, scope) → value
  AIOS.Saved:Set(ns, key, value, scope) → newValue
  AIOS.Saved:Reset(ns, scope)
  AIOS.Saved:OnChanged(ns, fn) → handle
  AIOS.Saved:GetAsync / SetAsync / ResetAsync → Promise
  AIOS.Saved:GetProfile() → profileName
  AIOS.Saved:SwitchProfile(name) → profileName
  AIOS.Saved:CopyProfile(src, dst, overwrite) → success
  AIOS.Saved:GetReactiveStore(ns, scope) → reactiveStore
]]
