--[[
AIOS_MediaCore.lua — AIOS Media Registry
Version: 1.0.0
Author: Poorkingz
...
Purpose:
  Tiny media registry for fonts, textures, sounds, and more.
  Safe defaults, no chat prints, integrates with AIOS_UIStyle if present.
...
API:
  Media:Register(mediaType, key, data[, opts])
  Media:Fetch(mediaType, key[, fallback]) : data
  Media:List(mediaType[, addon]) : {string}
  Media:Iterate(mediaType) : iterator
  Media._metrics -> {registers, fetches, misses}
--]]
